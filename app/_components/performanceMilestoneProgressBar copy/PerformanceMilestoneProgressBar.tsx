...
interface PerformanceMilestoneProgressBarProps {
  total: number
  points: number[]
  unit?: string
...
const PerformanceMilestoneProgressBar: React.FC<PerformanceMilestoneProgressBarProps> = ({
  total,
  points,
  unit,
  readyToCollect,
...
export default PerformanceMilestoneProgressBar
